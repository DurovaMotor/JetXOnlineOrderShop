(function () {
  var CART_KEY = "hightac-jetxonlineordershop-cart-v1";
  var SUBMISSION_KEY = "hightac-jetxonlineordershop-last-submission-v1";
  var LANG_KEY = "hightac-jetxonlineordershop-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "Jet X",
        motorPicture: "Database/MotorPictures/Jet X.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "Jet X";
